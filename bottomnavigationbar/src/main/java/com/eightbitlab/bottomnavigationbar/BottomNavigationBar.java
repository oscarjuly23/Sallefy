...
public class BottomNavigationBar extends LinearLayout {
    ...
    private void createStubForEditMode() {
        if (isInEditMode()) {
            addTab(new BottomBarItem(R.drawable.ic_home_black_24dp));
            addTab(new BottomBarItem(R.drawable.ic_search_24px));
            addTab(new BottomBarItem(R.drawable.ic_view_list_24px));
            addTab(new BottomBarItem(R.drawable.ic_account_circle_24px));
        }
    }
